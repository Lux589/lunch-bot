...
<div class="container">
    <div class="content">
        ...
        <a href="https://slack.com/oauth/authorize?client_id=4108686466.574916686132&scope=bot,channels:history,im:history,channels:read,im:read,commands,team:read,groups:history">
            <img alt="add to slack button" height="40" width="139" src="https://platform.slack-edge.com/img/add_to_slack.png" />
        </a>
    </div>
</div>
</body>
